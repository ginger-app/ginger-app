    ...
    switch (name) {
        ...
        case 'cart':
            return (
                ...
                >
                    ...
                    />
                    <path
                        d='M1 1H5L7.68 14.39C7.77144 14.8504 8.02191 15.264 8.38755 15.5583C8.75318 15.8526 9.2107 16.009 9.68 16H19.4C19.8693 16.009 20.3268 15.8526 20.6925 15.5583C21.0581 15.264 21.3086 14.8504 21.4 14.39L23 6H9'
                        stroke={color}
                        strokeWidth='2'
                        strokeLinecap='round'
                        strokeLinejoin='round'
        ...
        case 'link':
            return (
                ...
                >
                    <path
                        d='M8.46484 11.7861C9.95499 13.933 13.0904 13.556 14.6267 11.7861L17.6822 8.64498C19.409 6.71636 19.4704 4.22549 17.6822 2.36283C15.9371 0.545722 13.2825 0.545722 11.5373 2.36283L8.46484 5.50391'
                        stroke={color}
                        strokeWidth='2'
                        strokeLinecap='round'
                        strokeLinejoin='round'
                    />
                    <path
                        d='M11.5356 10.3239C10.0454 8.17696 6.92689 8.44395 5.39066 10.2139L2.31819 13.3158C0.591463 15.2444 0.530013 17.7745 2.31819 19.6372C4.06335 21.4543 6.7195 21.4543 8.46312 19.6372L11.5356 16.4961'
                        stroke={color}
                        strokeWidth='2'
                        strokeLinecap='round'
                        strokeLinejoin='round'
        ...
        case 'plus':
            return (
                <svg
                    ...
                    width={width || size || 14}
                    height={height || size || 14}
                    viewBox={`0 0 ${width || size || 28} ${height || size || 28}`}
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                >
                    <path
                        d='M13.5961 1.39951C13.5961 0.626314 14.2229 -0.000488281 14.9961 -0.000488281C15.7693 -0.000488281 16.3961 0.626313 16.3961 1.39951V26.5995C16.3961 27.3727 15.7693 27.9995 14.9961 27.9995C14.2229 27.9995 13.5961 27.3727 13.5961 26.5995V1.39951Z'
                        fill='black'
                    />
                    <path
                        d='M27.5961 15.3995C28.3693 15.3995 28.9961 14.7727 28.9961 13.9995C28.9961 13.2263 28.3693 12.5995 27.5961 12.5995H2.39609C1.6229 12.5995 0.996094 13.2263 0.996094 13.9995C0.996094 14.7727 1.6229 15.3995 2.39609 15.3995H27.5961Z'
                        fill={color}
                    />
                </svg>
            );
        ...
        case 'refresh':
            return (
                <svg
                    ...
                    width={width || size || 22}
                    height={height || size || 20}
                    viewBox={`0 0 ${width || size || 22} ${height || size || 20}`}
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                >
                    <path
                        d='M20.9975 1.99789V7.99947H15.543'
                        stroke={color}
                        strokeWidth='1.5'
                        strokeLinecap='round'
                        strokeLinejoin='round'
                    ...
                    />
                    <path
                        d='M3.28182 6.99921C3.74288 5.56562 4.52648 4.2839 5.55952 3.27365C6.59255 2.2634 7.84133 1.55755 9.18935 1.22195C10.5374 0.886355 11.9407 0.931957 13.2684 1.3545C14.596 1.77704 15.8048 2.56276 16.7818 3.63833L21 7.99947M1 12.0005L5.21818 16.3617C6.19523 17.4372 7.40398 18.223 8.73165 18.6455C10.0593 19.068 11.4626 19.1136 12.8106 18.7781C14.1587 18.4425 15.4075 17.7366 16.4405 16.7263C17.4735 15.7161 18.2571 14.4344 18.7182 13.0008'
                        stroke={color}
                        strokeWidth='1.5'
                        strokeLinecap='round'
                        strokeLinejoin='round'
        ...
        case 'dispute':
            return (
                <svg
                    ...
                    width={width || size || 24}
                    height={height || size || 22}
                    viewBox={`0 0 ${width || size || 24} ${height || size || 22}`}
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                >
                    <path
                        d='M7 15.5833H19C19.5304 15.5833 20.0391 15.3902 20.4142 15.0464C20.7893 14.7025 21 14.2362 21 13.75V4.58333C21 4.0971 20.7893 3.63079 20.4142 3.28697C20.0391 2.94315 19.5304 2.75 19 2.75H5C4.46957 2.75 3.96086 2.94315 3.58579 3.28697C3.21071 3.63079 3 4.0971 3 4.58333V19.25L5 17.4167'
                        stroke='#343A3F'
                        strokeWidth='2'
                        strokeLinecap='round'
                        strokeLinejoin='round'
                    />
                    <path
                        d='M12.85 10.2335H11.83L11.56 7.5835V5.5835H13.11V7.5835L12.85 10.2335ZM13.19 11.8635C13.19 12.0968 13.1067 12.2968 12.94 12.4635C12.7733 12.6302 12.5733 12.7135 12.34 12.7135C12.1067 12.7135 11.9067 12.6302 11.74 12.4635C11.5733 12.2968 11.49 12.0968 11.49 11.8635C11.49 11.6302 11.5733 11.4302 11.74 11.2635C11.9067 11.0968 12.1067 11.0135 12.34 11.0135C12.5733 11.0135 12.7733 11.0968 12.94 11.2635C13.1067 11.4302 13.19 11.6302 13.19 11.8635Z'
                        fill='black'
                    />
                </svg>
            );
